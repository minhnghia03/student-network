...
INSERT INTO "achievements" ("achievement_id","achievement_name","description","xp_value","icon","rarity") VALUES
	 (1,'Look at you','Vào trang cá nhân của bạn lần đầu',25,'address card','bronze'),
	 (2,'Looking good','Vào trang cá nhân của người khác lần đầu',25,'eye','bronze'),
	 (3,'Show it off','Mở tab thành tích lần đầu',25,'trophy','bronze'),
	 (4,'Connected','Thêm kết nối đầu tiên',50,'address book','silver'),
	 (5,'Popular','Thêm 10 kết nối',75,'address book','gold'),
	 (6,'Centre of attention','Thêm 100 kết nối',150,'address book','platinum'),
	 (7,'Express yourself','Đăng bài viết lần đầu',50,'file alternate','silver'),
	 (8,'5 posts','Đăng bài viết 5 lần',75,'file alternate','gold'),
	 (9,'20 posts','Đăng bài viết 20 lần',150,'file alternate','platinum'),
	 (10,'Commentary','Bình luận bài viết lần đầu',50,'comment','silver');
INSERT INTO "achievements" ("achievement_id","achievement_name","description","xp_value","icon","rarity") VALUES
	 (11,'Describe yourself','Mô tả bản thân bằng cách viết bio',25,'tags','bronze'),
	 (12,'Friends','Thêm kết nối gần gũi đầu tiên',50,'users','silver'),
	 (13,'Friend group','Thêm 10 kết nối gần gũi',75,'users','gold'),
	 (14,'Reaching out','Kết nối với 1 người bên ngoài chủ đề của bạn',50,'handshake','silver'),
	 (15,'Outside your bubble','Kết nối với 10 người bên ngoài chủ đề của bạn',75,'handshake','gold'),
	 (16,'Shared intrests','Kết nối với người khác có sở thích chung',50,'bowling ball','silver'),
	 (17,'Getting social','Gửi yêu cầu kết nối',25,'user plus','bronze'),
	 (18,'Show yourself','Thêm hình ảnh đại diện',25,'user circle','bronze'),
	 (19,'Liking that','Thích bài viết lần đầu',25,'thumbs up','bronze'),
	 (20,'First like','Nhận được thích trên bài viết',50,'heart','silver');
INSERT INTO "achievements" ("achievement_id","achievement_name","description","xp_value","icon","rarity") VALUES
	 (21,'Hot topic','Có bài viết đạt 10 bình luận',100,'comments','gold'),
	 (22,'Everyone loves you','Có bài viết đạt 50 lượt thích',100,'heart','gold'),
	 (23,'Secret meeting','Đăng nhập trong một sự kiện đặc biệt',300,'user secret','diamond'),
	 (24,'Show the love','Thích 50 bài viết',75,'thumbs up','gold'),
	 (25,'Loving everything','Thích 500 bài viết',150,'thumbs up','platinum'),
	 (26,'Shared hobbies','Kết nối với người khác có sở thích chung',50,'paint brush','silver'),
	 (27,'Boffin','Hoàn thành quiz',25,'question','bronze'),
	 (28,'Brainiac','Hoàn thành quiz với điểm số hoàn hảo',75,'question','gold'),
	 (29,'Secret Agent','Tìm ra lỗi nghiêm trọng trên trang web và báo cáo nó',1000,'desktop','black'),
	 (30,'Trivia writer','Có người chơi quiz của bạn lần đầu',50,'question','silver');
INSERT INTO "achievements" ("achievement_id","achievement_name","description","xp_value","icon","rarity") VALUES
	 (31,'Learning','Play a flashcard set for the first time',25,'clone','bronze'),
	 (32,'Teacher','Có người chơi flashcard của bạn lần đầu',50,'clone','silver'),
	 (33,'Professor','Flashcard của bạn đạt 50 lượt chơi',100,'clone','gold');
...
INSERT INTO "notification" ("username","body","date","url") VALUES
	 ('student2','Bạn đã được đề cập bởi student1 trong bài viết!','2021-05-21 03:20:50','/post_page/1'),
	 ('student1','student2 đã bình luận trên bài viết của bạn!','2021-05-21 03:21:03','/post_page/1'),
	 ('student1','Bạn đã được đề cập bởi student2 trong bài viết!','2021-05-21 03:21:17','/post_page/2'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-21 03:21:18','/achievements'),
	 ('student2','Bạn đã được đề cập bởi student1 trong bài viết!','2021-05-21 03:56:23','/post_page/3'),
	 ('student2','Bạn đã được đề cập bởi student1 trong bài viết!','2021-05-21 04:00:23','/post_page/4'),
	 ('student1','Bạn đã nhận được một huy hiệu!','2021-05-24 21:53:01','/achievements'),
	 ('student1','Bạn đã nhận được một huy hiệu!','2021-05-24 21:53:01','/achievements'),
	 ('student2','Bạn đã được đề cập bởi student1 trong bài viết!','2021-05-24 23:56:08','/post_page/5'),
	 ('student6','Bạn đã nhận được một huy hiệu!','2021-05-27 01:44:37','/achievements');
INSERT INTO "notification" ("username","body","date","url") VALUES
	 ('student6','Bạn đã nhận được một huy hiệu!','2021-05-27 01:44:38','/achievements'),
	 ('student6','Bạn đã nhận được một huy hiệu!','2021-05-27 01:44:53','/achievements'),
	 ('student7','Bạn đã nhận được một huy hiệu!','2021-05-27 01:46:17','/achievements'),
	 ('student7','Bạn đã nhận được một huy hiệu!','2021-05-27 01:46:17','/achievements'),
	 ('student7','Bạn đã nhận được một huy hiệu!','2021-05-27 01:46:33','/achievements'),
	 ('student6','Bạn đã nhận được một huy hiệu!','2021-05-27 01:46:56','/achievements'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-27 10:45:14','/achievements'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-27 10:47:08','/achievements'),
	 ('student8','Bạn đã nhận được một huy hiệu!','2021-05-29 00:29:09','/achievements'),
	 ('student8','Bạn đã nhận được một huy hiệu!','2021-05-29 00:29:14','/achievements');
INSERT INTO "notification" ("username","body","date","url") VALUES
	 ('student1','Bạn đã nhận được một huy hiệu!','2021-05-29 00:58:38','/achievements'),
	 ('student1','Bạn đã nhận được một huy hiệu!','2021-05-29 00:58:38','/achievements'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-29 00:59:18','/achievements'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-29 00:59:18','/achievements'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-29 01:00:38','/achievements'),
	 ('student2','Bạn đã nhận được một huy hiệu!','2021-05-29 01:00:38','/achievements'),
	 ('student1','Bạn đã nhận được một huy hiệu!','2021-05-30 18:14:20','/achievements'),
	 ('student5','Bạn đã nhận được một huy hiệu!','2021-05-30 18:15:10','/achievements'),
	 ('student5','Bạn đã nhận được một huy hiệu!','2021-05-30 18:15:10','/achievements'),
	 ('student5','Bạn đã nhận được một huy hiệu!','2021-05-30 18:19:55','/achievements');
INSERT INTO "notification" ("username","body","date","url") VALUES
	 ('student5','Bạn đã nhận được một huy hiệu!','2021-05-30 18:21:00','/achievements'),
	 ('student2','Bạn đã được đề cập bởi student1 trong bài viết!','2021-05-31 00:24:29','/post_page/12'),
	 ('student1000','Bạn đã nhận được một huy hiệu!','2021-08-06 23:22:57','/achievements'),
	 ('student1001','Bạn đã nhận được một huy hiệu!','2021-08-06 23:29:52','/achievements'),
	 ('student1002','Bạn đã nhận được một huy hiệu!','2021-08-06 23:31:45','/achievements'),
	 ('staffuser','Bạn đã nhận được một huy hiệu!','2025-04-20 20:09:56','/achievements'),
	 ('staffuser','Bạn đã nhận được một huy hiệu!','2025-04-20 20:10:19','/achievements'),
	 ('staffuser','Bạn đã nhận được một huy hiệu!','2025-04-20 20:10:54','/achievements');
